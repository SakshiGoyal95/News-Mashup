...
public class TestWindow {
	...
	private void initialize() {
		...
		btnSignIn.addContainerListener(new ContainerAdapter() {
			@Override
		...
		btnSignIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//You have clicked on Sign In. What next?
			}
		});
		...
		lblNewLabel_1.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Title.gif")));
		...
		label_2.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/World.jpg")));
		...
		label_3.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Business.jpg")));
		...
		label_4.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Sports.jpg")));
		...
		label_5.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Politics.jpg")));
		...
		label_6.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Technology.jpg")));
		...
		label_7.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Entertainment.jpg")));
		...
		label_8.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Education.jpg")));
		...
		label_9.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Money.jpg")));
		...
		label_10.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Travel.jpg")));
		...
		label_11.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Health.png")));
		...
		label_12.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Science.jpg")));
		...
		label_13.setIcon(new ImageIcon(TestWindow.class.getResource("/news_GUI_1/img/Magazine.jpg")));
