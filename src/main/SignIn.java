...
public class SignIn {
	...
	private void initialize() {
		...
		EmailField.setBounds(88, 12, 185, 20);
		panel_6.add(EmailField);
		EmailField.setColumns(10);
		
		pwdFld = new JPasswordField();
		pwdFld.setBounds(88, 37, 185, 20);
		panel_6.add(pwdFld);
		...
		lblNewLabel_1.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Title.gif")));
		...
		label_2.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/World.jpg")));
		...
		label_3.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Business.jpg")));
		...
		label_4.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Sports.jpg")));
		...
		label_5.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Politics.jpg")));
		...
		label_6.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Technology.jpg")));
		...
		label_7.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Entertainment.jpg")));
		...
		label_8.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Education.jpg")));
		...
		label_9.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Money.jpg")));
		...
		label_10.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Travel.jpg")));
		...
		label_11.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Health.png")));
		...
		label_12.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Science.jpg")));
		...
		label_13.setIcon(new ImageIcon(SignIn.class.getResource("/news_GUI/img/Magazine.jpg")));
	...
	System.out.println("joihuj");
	ResultSet rs;
	rs=stmt.executeQuery("select * from signup");
	boolean s=false;
	while(rs.next())
	{
		if(EmailField.getText().equals(rs.getString(2)) && pwdFld.getPassword().equals(rs.getString(3)) )
		{
			s=true;
